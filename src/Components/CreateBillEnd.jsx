export default function End(){
    return(
        <div className="flex flex-col">
            <div className="w-full ml-[1px] h-24 flex flex-col justify-center items-center bg-gray-400">
            ...
            <div className="w-full ml-[1px] h-24 text-green-700 flex mt-[1px] flex-col justify-center items-center bg-gray-400">
                ...
                <span className="text-black">F3 - cASH</span>
            </div>
            <div className="w-full ml-[1px] h-24 flex flex-col justify-center  mt-[1px] items-center bg-gray-400">
